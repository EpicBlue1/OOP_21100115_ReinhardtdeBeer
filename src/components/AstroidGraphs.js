  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        for (var i = 0; i < dataDate.length; i++) {
          totalS +=
            (dataDate[i].estimated_diameter.meters.estimated_diameter_max +
              dataDate[i].estimated_diameter.meters.estimated_diameter_max) /
            2;
        }
        ...
        for (var i = 0; i < dataDate.length; i++) {
          textOne =
            dataDate[i].close_approach_data[0].relative_velocity
              .kilometers_per_hour;
        ...
        for (let i = 0; i < dataDate.length; i++) {
          ...
          let magMd =
            (avgMD /
              dataDate[i].close_approach_data[0].miss_distance.kilometers) *
            100;
          if (magMd > 100) {
            magMd = 100;
          }
        ...
        for (let i = 0; i < dataDate.length; i++) {
          CompareDatasetOne.push({
            ...
            Index: i,
            Size:
              (dataDate[i].estimated_diameter.meters.estimated_diameter_min +
                dataDate[i].estimated_diameter.meters.estimated_diameter_max) /
              2,
            MissDistance:
              dataDate[i].close_approach_data[0].miss_distance.kilometers,
            MissDistanceLunar:
              dataDate[i].close_approach_data[0].miss_distance.lunar,
            Velocity:
              dataDate[i].close_approach_data[0].relative_velocity
                .kilometers_per_hour,
      ...
      <Row>
        <Col>
          <div className="GraphOne">
            ...
            <div className="Description">
              <br></br>
              <p>Sizes of two Asteroids shown and compared on Pie Chart</p>
            </div>
          </div>
        </Col>
        ...
        <Col>
          ...
          <div className="GraphTwo">
            ...
            <div className="Description">
              <br></br>
              <p>Sizes of two Asteroids shown and compared on Bar Chart</p>
            </div>
          </div>
        </Col>
      </Row>
